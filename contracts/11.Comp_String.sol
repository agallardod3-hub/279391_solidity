...
contract Complejo1 {
    ...
    function saludarHex() public view returns(string memory) {
        return saludo;
    }

    function saludarA(string memory nombre) public view returns(string memory) {
        return string(abi.encodePacked(saludo, " ", nombre));
    }
